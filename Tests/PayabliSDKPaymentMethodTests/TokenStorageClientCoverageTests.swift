...
final class TokenStorageClientCoverageTests: XCTestCase {
    ...
    func testDiagnosticsRedactsArrayResponsesAndNonJSONBodies() async throws {
        ...
        """)
        let arrayClient = TokenStorageClient(
        ...
        let nonJSONClient = TokenStorageClient(
    ...
    func testInvalidEntryPointAndMissingAccessTokenDoNotReachTransport() async throws {
        ...
        let invalidEntryClient = TokenStorageClient(
        ...
        let missingTokenClient = TokenStorageClient(
        ...
        } catch PayabliPaymentMethodError.missingAccessToken {
    ...
    func testACHViewModelDefaultsNilHiddenSecCodeToWeb() async throws {
        ...
        let viewModel = PayabliPaymentMethodViewModel(
            ...
            configuration: PayabliPaymentMethodFormConfiguration(
                allowedMethods: [.ach],
                defaultMethod: .ach,
                hiddenValues: PayabliPaymentMethodHiddenValues(achSecCode: nil)
            )
        )
