...
final class PaymentMethodKeyboardAccessoryTests: XCTestCase {
    private typealias Field = PayabliPayInUIKitTextField
    ...
    func testTheFormsNumericFieldsAreOnANumberPad() {
        let numeric: [PayabliPayInField] = [.cardNumber, .cardCvv, .routingNumber, .accountNumber]
    ...
    func testTheBarCarriesADoneControlAddressableByIdentifier() throws {
        ...
        XCTAssertEqual(done.accessibilityIdentifier, PayabliPayInAccessibility.keyboardDoneIdentifier)
        XCTAssertEqual(done.accessibilityLabel, PayabliPayInAccessibility.keyboardDoneLabel)
    ...
    private func numberPadField() -> PayabliPayInUIKitTextField {
