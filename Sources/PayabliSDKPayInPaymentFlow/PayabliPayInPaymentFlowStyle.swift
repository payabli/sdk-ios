...
public struct PayabliPayInPaymentFlowTextStyle: Sendable {
...
public struct PayabliPayInPaymentFlowInputStyle {
    public let font: Font
...
public struct PayabliPayInPaymentFlowSubmitButtonStyle {
    public let font: Font
    public let backgroundColor: Color?
...
public struct PayabliPayInPaymentFlowLayoutStyle {
...
public struct PayabliPayInPaymentFlowStyle {
    public let accentColor: Color
    public let title: PayabliPayInPaymentFlowTextStyle
    public let subtitle: PayabliPayInPaymentFlowTextStyle
    public let sectionTitle: PayabliPayInPaymentFlowTextStyle
    public let label: PayabliPayInPaymentFlowTextStyle
    public let input: PayabliPayInPaymentFlowInputStyle
    public let submitButton: PayabliPayInPaymentFlowSubmitButtonStyle
    public let error: PayabliPayInPaymentFlowTextStyle
    public let layout: PayabliPayInPaymentFlowLayoutStyle

    public init(
        accentColor: Color = .accentColor,
        title: PayabliPayInPaymentFlowTextStyle = PayabliPayInPaymentFlowTextStyle(
            font: .title3.weight(.semibold),
            color: .primary
        ),
        subtitle: PayabliPayInPaymentFlowTextStyle = PayabliPayInPaymentFlowTextStyle(
            font: .subheadline,
            color: .secondary
        ),
        sectionTitle: PayabliPayInPaymentFlowTextStyle = PayabliPayInPaymentFlowTextStyle(
            font: .subheadline.weight(.semibold),
            color: .primary
        ),
        label: PayabliPayInPaymentFlowTextStyle = PayabliPayInPaymentFlowTextStyle(
            font: .footnote.weight(.medium),
            color: Color(uiColor: .secondaryLabel)
        ),
        input: PayabliPayInPaymentFlowInputStyle = PayabliPayInPaymentFlowInputStyle(),
        submitButton: PayabliPayInPaymentFlowSubmitButtonStyle = PayabliPayInPaymentFlowSubmitButtonStyle(),
        error: PayabliPayInPaymentFlowTextStyle = PayabliPayInPaymentFlowTextStyle(
            font: .footnote,
            color: .red
        ),
        layout: PayabliPayInPaymentFlowLayoutStyle = PayabliPayInPaymentFlowLayoutStyle()
    ) {
    ...
    public static let `default` = PayabliPayInPaymentFlowStyle()
}

private struct PayabliPayInPaymentFlowStyleKey: EnvironmentKey {
    static let defaultValue = PayabliPayInPaymentFlowStyle.default
}

public extension EnvironmentValues {
    var payabliPayInPaymentFlowStyle: PayabliPayInPaymentFlowStyle {
        get { self[PayabliPayInPaymentFlowStyleKey.self] }
        set { self[PayabliPayInPaymentFlowStyleKey.self] = newValue }
    }
}

public extension View {
    func payabliPayInPaymentFlowStyle(_ style: PayabliPayInPaymentFlowStyle) -> some View {
        environment(\.payabliPayInPaymentFlowStyle, style)
    }
}
