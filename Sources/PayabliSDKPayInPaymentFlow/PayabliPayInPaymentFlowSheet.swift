...
public enum PayabliPayInPaymentFlowSheetDismissButton: Sendable, Equatable {
    case close
    case back
    case hidden
}

public struct PayabliPayInPaymentFlowSheetConfiguration {
    public let title: String?
    public let subtitle: String?
    public let dismissButton: PayabliPayInPaymentFlowSheetDismissButton
    ...
    public init(
        title: String? = nil,
        subtitle: String? = nil,
        dismissButton: PayabliPayInPaymentFlowSheetDismissButton = .close,
...
public extension View {
    func payabliPayInPaymentFlowSheet(
        ...
        sheetConfiguration: PayabliPayInPaymentFlowSheetConfiguration = PayabliPayInPaymentFlowSheetConfiguration(),
        style: PayabliPayInPaymentFlowStyle? = nil,
        onCompleted: @escaping (PayabliPayInPaymentFlowResult) -> Void,
        onError: @escaping (Error) -> Void = { _ in }
    ) -> some View {
        sheet(isPresented: isPresented) {
            PayabliPayInPaymentFlowSheetContent(
...
struct PayabliPayInPaymentFlowSheetContent: View {
    ...
    init(
        ...
        style: PayabliPayInPaymentFlowStyle?,
        onCompleted: @escaping (PayabliPayInPaymentFlowResult) -> Void,
    ...
    var body: some View {
        GeometryReader { proxy in
                ...
                .background(
                    GeometryReader { contentProxy in
                        Color.clear.preference(
                            key: PayInPaymentFlowSheetContentHeightKey.self,
            ...
            .onPreferenceChange(PayInPaymentFlowSheetContentHeightKey.self) { contentHeight in
    ...
    private var formConfiguration: PayabliPayInPaymentFlowFormConfiguration {
        ...
        return PayabliPayInPaymentFlowFormConfiguration(
            ...
            bankFieldOrder: configuration.bankFieldOrder,
            cardSections: configuration.cardSections,
            bankSections: configuration.bankSections,
    ...
    private static func initialDetent(
        for sheetConfiguration: PayabliPayInPaymentFlowSheetConfiguration
    ) -> PresentationDetent {
...
private struct PayInPaymentFlowSheetContentHeightKey: PreferenceKey {
...
extension PayabliPayInPaymentFlowSheetDismissButton {
