...
package final class MockAppAttestor: AppAttestor, @unchecked Sendable {
    ...
    package var generatedKeyId: AppAttestKeyId {
    ...
    package var attestationPayload: AttestationObject {
    ...
    package var beforeGenerateKey: (@Sendable () async -> Void)? {
    ...
    package var beforeGenerateAssertion: (@Sendable () async -> Void)? {
