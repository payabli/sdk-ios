...
/// or network access.
package final class MockDeviceAttestationService: DeviceAttestationService, @unchecked Sendable {
    ...
    package var isAlreadyAttested: Bool {
    ...
    package var cachedDeviceId: String? {
    ...
    package static let anyEntry = "mockEntry"
    ...
    package var bindingKeys: [String: String] {
    ...
    package static let defaultKeyId = "mock_key"
    ...
    package var attestResult: Result<AttestationResult, Error> {
    ...
    package var clearFailure: Error? {
