...
enum PayabliPayInAccessibility {
    static let minimumTouchTarget: CGFloat = 44

    static func fieldIdentifier(_ field: PayabliPayInField) -> String {
    ...
    static let expirationDoneIdentifier = "payabli.payIn.control.expirationDone"
    ...
    static let keyboardDoneIdentifier = "payabli.payIn.control.keyboardDone"
