enum PayabliPayInInputLimits {
    ...
    static let routingNumberDigits = 9
    static let minimumAccountNumberDigits = 4
    static let maximumAccountNumberDigits = 17
    static let maximumAccountHolderNameCharacters = 60
}
