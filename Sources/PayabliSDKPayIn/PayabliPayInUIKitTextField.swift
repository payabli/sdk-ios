...
struct PayabliPayInUIKitTextField: UIViewRepresentable {
    ...
    init(
        ...
        focusedField: Binding<PayabliPayInField?>,
    ...
    func updateUIView(_ textField: UITextField, context: Context) {
        ...
        textField.accessibilityValue = PayabliPayInAccessibility.textFieldValue(
            text: sanitizedText,
    ...
    final class Coordinator: NSObject, UITextFieldDelegate {
        var parent: PayabliPayInUIKitTextField
        weak var textField: UITextField?
        private var doneAccessory: UIInputView?

        init(_ parent: PayabliPayInUIKitTextField) {
            self.parent = parent
        }
        ...
        func doneAccessoryView() -> UIInputView {
            ...
            done.accessibilityLabel = PayabliPayInAccessibility.keyboardDoneLabel
            done.accessibilityIdentifier = PayabliPayInAccessibility.keyboardDoneIdentifier
            done.addTarget(self, action: #selector(endEditing), for: .touchUpInside)
            done.translatesAutoresizingMaskIntoConstraints = false
            bar.addSubview(done)

            let target = PayabliPayInAccessibility.minimumTouchTarget
            NSLayoutConstraint.activate([
