...
public typealias PayabliPaymentCaptureAccessTokenProvider = @Sendable () async throws -> String

/// Module-level namespace for `PayabliSDKPaymentCapture` metadata.
///
...
public enum PayabliPaymentCaptureModule {
